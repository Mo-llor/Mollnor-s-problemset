...
[HH 的项链](https://www.luogu.com.cn/problem/P1972) [题解喵](/tree/HH_的项链.md)这个也是差不多的思路喵，但是因为我找错了二维偏序的两个变量，导致我想了两个小时没想出来喵，正解是离线写的喵，但我毕竟是在练主席树喵，所以就写了在线的写法喵，还有就是这个转化出来是和HH的项链是一个类型的题目，但是我没转化出来喵 [Barkley II](https://codeforces.com/gym/104768/problem/I)
